...
def escutar_porta_Virloc(conexao, estado_virloc): # Aqui implementamos o outro cérebro do código, uma escuta passiva que fica aguardando todas as mensagens que chegam do virloc
    buffer_rx = ""
    while True: 
        try:
